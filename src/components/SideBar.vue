  ...
  <div class="h-[100%] w-[3.4rem]">
    ...
    >
      <div class="flex flex-col justify-between pt-2 pb-6">
        <div>
          <div class="w-[50rem] py-3 px-[0.5rem]">
            <router-link to="#">
              <img
                class="w-[2.5rem] h-[2.5rem]"
                src="../../public/img/kart-rio.png"
                alt="logo"
              />
            </router-link>
          </div>
          <ul class="mt-6 space-y-2 tracking-wide">
            <li class="min-w-max">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  class="w-auto h-[1.70rem]"
                >
                  <path
                    class="text-gray-400 group-hover:text-gray-400"
                    fill-rule="evenodd"
                    d="M7.502 6h7.128A3.375 3.375 0 0118 9.375v9.375a3 3 0 003-3V6.108c0-1.505-1.125-2.811-2.664-2.94a48.972 48.972 0 00-.673-.05A3 3 0 0015 1.5h-1.5a3 3 0 00-2.663 1.618c-.225.015-.45.032-.673.05C8.662 3.295 7.554 4.542 7.502 6zM13.5 3A1.5 1.5 0 0012 4.5h4.5A1.5 1.5 0 0015 3h-1.5z"
                    clip-rule="evenodd"
                  />
                  <path
                    class="fill-current text-gray-600 group-hover:text-green-700"
                    fill-rule="evenodd"
            ...
            <li class="min-w-max">
              ...
              >
                ...
                >
                  <path
                    class="fill-current text-gray-400 group-hover:text-gray-400"
                    fill-rule="evenodd"
